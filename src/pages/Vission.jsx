...
>
  ...
  />
    ...
    {/* Overlay with bottom-aligned text */}
    <div className="absolute inset-0 bg-black/40 flex flex-col justify-center items-start p-4 md:p-12">
      <h1 className="text-white text-2xl mb-3 md:text-5xl font-bold w-full">
        Vision and Mission
      </h1>
      ...
      <Link to="/contact">
        <button
          className="md:px-6 px-3 mt-3 py-3 text-xs md:text-sm rounded-lg font-semibold flex items-center justify-center gap-2 
      ...
      <div className="px-6 py-6 flex justify-center">
        <div className="grid md:grid-rows-2 gap-6 w-full max-w-4xl">

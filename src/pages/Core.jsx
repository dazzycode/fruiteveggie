...
>
  ...
  />
               <div className="absolute inset-0 bg-black/40 flex flex-col justify-center items-start p-4 md:p-12">
                 ...
                 <p className="text-white md:text-lg text-xs w-full md:max-w-3xl">
...
We prioritize environmentally friendly and climate-smart practices across our operations.
               </p>
             </div>
             <div>
               ...
               <p className="text-sm text-gray-600">
We build trust through transparency, accountability, and fairness.
               </p>
             </div>
             <div>
               ...
               <p className="text-sm text-gray-600">
 We embrace technology and creativity to transform agriculture.
               </p>
             </div>
             <div>
               ...
               <p className="text-sm text-gray-600">
 We believe in partnerships that create shared value for farmers, communities, and stakeholders.
               </p>
             </div>
             <div>
               ...
               <p className="text-sm text-gray-600">
We are committed to uplifting farmers, especially women and youth, to thrive in agribusiness.
               </p>
             </div>
             <div>
               ...
               <p className="text-sm text-gray-600">
We deliver high-quality produce, services, and solutions that meet global standards.               </p>
             </div>
           </div>
         </div>
       </div>

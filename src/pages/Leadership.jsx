...
>
  ...
  {team.map((person, idx) => (
    <div key={idx}       className="flex border-2    border border-[#BDDA02] text-black
                    shadow-[0_0_10px_#BDDA02] hover:shadow-[0_0_20px_#BDDA02]  
 flex-col items-center bg-white rounded-xl shadow-md p-4 transition hover:shadow-xl h-full"
>
      <img
        src={person.img}
        alt={person.name}
      ...
      <p className="md:text-sm  text-xs text-gray-600">{person.role}</p>
    </div>
  ))}
</div>
</div>

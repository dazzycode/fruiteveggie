...
const sdgs = [
  ...
  return (
    ...
    <section className="relative w-full font-roboto">
      {/* Background image */}
      ...
      {/* Content */}
      <div className="relative z-10 flex flex-col justify-start mx-10 px-6 md:px-20 max-w-4xl pt-28 md:pt-40 pb-16">
        ...
        <p className="text-white mt-4 text-xs md:text-lg max-w-2xl">
          We are revolutionizing Nigeria’s agricultural value chain through
          sustainable farming, post-harvest solutions, and market access. From
          seed to storage, we empower farmers, reduce losses, and deliver fresh,
          high-quality produce to communities and markets.
        </p>
        <div className="mt-6 flex flex-col sm:flex-row gap-4">
      <Link to="/contact">  <button className="md:px-6 px-3  py-3 text-xs md:text-sm  rounded-lg font-semibold flex items-center justify-center gap-2 
 ...
 <Link to="/contact">  <button className="md:px-6 px-3 py-3 rounded-lg text-xs md:text-sm font-semibold flex items-center justify-center gap-2 
  ...
  transition duration-300 ease-in-out active:scale-95">
      ...
      <style jsx>{`
        section {
          min-height: 60vh; /* Default for mobile */
        }
        @media (min-width: 768px) {
          section {
            min-height: 70vh; /* Tablets */
          }
        }
...
<SwiperSlide>
  <div className="flex flex-col py-5 items-left ">
    ...
    <p className="text-black md:text-lg text-left text-xs mb-6 mt-2">
      To create a future where every community in Africa has access to fresh,
      nutritious food through sustainable farming practices and innovation.
    </p>
    ...
    <p className="text-black md:text-lg text-xs text-left mb-8 mt-2">
      We work to empower farmers with knowledge, resources, and markets that
      enable them to thrive while feeding the continent responsibly.
    </p>
  </div>
</SwiperSlide>
...
<SwiperSlide>
  <div className="flex flex-col py-5 items-left ">
    ...
    <h4 className="font-bold text-left text-sm text-red-700 tracking-widest">The Vision</h4>
    <p className="text-black md:text-lg text-left text-xs mb-6 mt-2">
      To be a leader in transforming agriculture into a driver of prosperity,
      resilience, and food security across Africa.
    </p>
    <h4 className="font-bold text-left text-sm text-red-700 tracking-widest">The Mission</h4>
    <p className="text-black md:text-lg text-xs text-left mb-8 mt-2">
      By building strong value chains, improving storage, and connecting farmers
      to fair markets, we ensure that no harvest goes to waste.
    </p>
  </div>
</SwiperSlide>
...
<SwiperSlide>
  ...
  transition duration-300 ease-in-out active:scale-95 mx-auto">
    ...
    <section className="bg-[#0f3d2e] text-white items-center justify-center py-8 px-6 md:px-20">
      <div className="max-w-5xl mx-auto">
        {/* Heading & Button */}
        <div className="flex flex-col md:flex-row mt-20 justify-between items-start md:items-center gap-6">
          <h2 className="text-3xl md:text-4xl font-bold leading-tight">
            Building a Sustainable Future, <br />
            From Farm to Market.
          </h2>
         <Link to="/services">    <button className="flex items-center gap-2 bg-[#BDDA02] text-black font-semibold px-5 py-3 rounded-lg shadow-md shadow-[0_0_30px_#BDDA02] hover:shadow-[0_0_10px_#BDDA02] 
  ...
  sustainability, and farmer empowerment—building a<br />
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6 max-w-5xl mx-auto">
          <div className="relative">
            ...
            <div className="absolute bottom-0 left-0 right-0 bg-black bg-opacity-50 text-white p-3 rounded-b-xl">
              Solar Cold Storage Utilization (partnership with Eweto Concept)
            </div>
          </div>
          <div className="relative">
            <img
            ...
            />
            <div className="absolute bottom-0 left-0 right-0 bg-black bg-opacity-50 text-white p-3 rounded-b-xl">
              School Gardening & Youth Empowerment Program (with Ogun State First Lady)
            </div>
          </div>
          <div className="relative md:col-span-2">
            ...
            />
            <div className="absolute bottom-0 left-0 right-0 bg-black bg-opacity-50 text-white p-3 rounded-b-xl">
              Large Scale Farming Project (Eweto Concept Partnership)
            </div>
          </div>
        </div>
      </section>
<div
  className="py-6 px-4 mt-20 text-center font-semibold "
>
  <h2 className="text-base md:text-3xl font-bold mx-auto leading-snug max-w-2xl mb-4">
    At Fruitiveggie, success is measured not only in numbers, but in{" "}
...
{selectedSDG && (
  <div className="fixed inset-0 flex items-center justify-center bg-black bg-opacity-50 z-50">
    <div className="bg-white p-6 rounded-lg max-w-md w-full relative">
      ...
      <div className="py-8 px-6 text-center bg-gray-50">
        <h2 className="text-xl text-red-700 font-bold mb-6">
         Our  partners 
        </h2>
        <div className="flex justify-center flex-wrap gap-8">
          <img src="/logo1.png" alt="SDG 1" className="h-16" />
          <img src="/logo2.png" alt="SDG 2" className="h-16" />
          <img src="logo3.png" alt="SDG 5" className="h-16" />
          <img src="/logo4.png" alt="SDG 8" className="h-16" />
        </div>
      </div>
  ...
  <img src="/logo5.png" alt="Our Partners" className="h-16" />
</div> </div>

    <div className="bg-gray-50">
      {/* FAQ Section */}
     
    <div className="bg-[#f5f7f5] flex flex-col items-center justify-center py-12 px-4">
      {/* Image Section */}
      <div className="relative w-full max-w-4xl">
        <img
          src="/faq.png" 
          alt="Support"
          className="w-full rounded-t-2xl object-cover h-[420px]"
        />
  ...
  transition duration-300 ease-in-out active:scale-95 mx-auto">
      ...
      <div className="relative bg-gradient-to-r from-[#224031] to-[#6DBD29] mx-2 text-white px-6 py-8 mt-8 text-left rounded-t-[30px] rounded-b-[30px]">
        ...
        <a
  href="mailto:smith@fruitnveggis.com" > <button className="md:px-6 px-3  py-2 text-xs md:text-sm mt-3  rounded-full font-semibold flex items-center justify-center gap-2 
  bg-[#BDDA02] text-black 
  shadow-[0_4px_15px_rgba(189,218,2,0.6)] 
  hover:shadow-[0_6px_20px_rgba(189,218,2,0.8)] 
  transition duration-300 ease-in-out active:scale-95">
      ...
      {/* ================= FOOTER ================= */}
    <footer className="bg-green-950 text-white  rounded-t-[20px] mt-2 relative z-10">

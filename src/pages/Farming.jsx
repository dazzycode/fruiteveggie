    ...
    <section className="max-w-6xl mx-auto px-4 py-12 gap-10 items-center">
      ...
      <div className="space-y-6">
        ...
        <p className="text-gray-700 text-sm md:text-base leading-relaxed">
          We grow high-quality vegetables and fruits using sustainable practices
          to meet consumer demand while protecting the environment. Our farms
          are built on innovation, eco-friendly methods, and a deep respect for
          nature.
        </p>
      </div>
